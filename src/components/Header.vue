<template>
  <navbar>
    ...
    <ul class="nav navbar-nav d-md-down-none">
       ...
       <li class="nav-item header-item">
          ...
          <router-link tag="div" to='/'  style="height:55px;" class="nav-link">
            ...
            <p  style="color:white"> ABC金融后台 </p>
        </router-link> 
      </li>
        <li class="nav-item header-item">
        
        <router-link tag="div" to='/dash1'  style="height:55px;" class="nav-link">
            <p><Icon type="stats-bars" size='30' color="#2d8cf0"></Icon></p>
            <p  style="color:white"> 门户后台 </p>
        </router-link> 
   ...
   <li class="nav-item header-item">
        ...
        <Dropdown>
      <router-link tag="div" to='/dash2'  style="height:55px;" class="nav-link">
            <p><Icon type="android-cloud" size='30' color="#2d8cf0"></Icon></p>
            <p  style="color:white"> 应用监控 </p>
        </router-link>
        ...
        <li class="nav-item header-item">
         ...
         <router-link tag="div" to='/dash3'  style="height:55px;" class="nav-link">
            <p><Icon type="trophy" size='30' color="#2d8cf0"></Icon></p>
            <p  style="color:white"> 企业报表 </p>
        </router-link> 
